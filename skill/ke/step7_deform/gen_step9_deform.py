...
def main():
    ...
    for d in subs:
        ...
        kc.render_tpl(tpl, {"SYSTEM": "%s deform %s" % (cwd.name, d.name),
                            "ENCUT": encut, "GGA": GGA_MAP[FUNC]}, d / "INCAR")
        sub = d / "submit.sh"
